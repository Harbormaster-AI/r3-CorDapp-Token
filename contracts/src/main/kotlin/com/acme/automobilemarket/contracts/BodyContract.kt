...
class BodyContract : EvolvableTokenContract(), Contract {
    override fun additionalCreateChecks(tx: LedgerTransaction) {
        val newToken = tx.outputStates.single() as BodyTokenState
        newToken.apply {
    ...
    companion object {
        const val CONTRACT_ID = "com.acme.automobilemarket.contracts.BodyContract"
    }
}
