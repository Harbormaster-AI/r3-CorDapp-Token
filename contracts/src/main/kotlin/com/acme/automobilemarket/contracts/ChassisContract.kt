...
class ChassisContract : EvolvableTokenContract(), Contract {
    override fun additionalCreateChecks(tx: LedgerTransaction) {
        val newToken = tx.outputStates.single() as ChassisTokenState
        newToken.apply {
    ...
    companion object {
        const val CONTRACT_ID = "com.acme.automobilemarket.contracts.ChassisContract"
    }
}
