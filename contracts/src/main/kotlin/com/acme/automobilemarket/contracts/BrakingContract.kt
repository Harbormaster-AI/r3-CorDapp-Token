...
class BrakingContract : EvolvableTokenContract(), Contract {
    override fun additionalCreateChecks(tx: LedgerTransaction) {
        val newToken = tx.outputStates.single() as BrakingTokenState
        newToken.apply {
    ...
    companion object {
        const val CONTRACT_ID = "com.acme.automobilemarket.contracts.BrakingContract"
    }
}
